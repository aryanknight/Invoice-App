    ...
    return (
        <div className='introSection'>
            ...
            <div className='introText'>
                ...
                <p style={{fontSize:'26px',marginTop:'20px'}}>Easy <b>Invoices</b> for Small Businesses . Create and Manage Unlimited Invoices for FREE. Developed By <b>Aryan Knight </b>.</p>
